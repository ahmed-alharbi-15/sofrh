  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('خطتي', style: TextStyle(color: Colors.white, fontFamily: 'NotoSansArabic')),
        centerTitle: true,
      ),
      body: _loading
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                _sectionCard(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      const Text('الميزانية', style: TextStyle(color: Colors.grey, fontFamily: 'NotoSansArabic')),
                    ]),
                    Slider(
                      value: _budget,
                      min: 1000, max: 50000, divisions: 49,
                      activeColor: accent, inactiveColor: Colors.grey[300],
                      onChanged: (v) => setState(() => _budget = v),
                    ),
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      const Text('50,000 ﷼', style: TextStyle(fontSize: 11, color: Colors.grey)),
                      const Text('1,000 ﷼', style: TextStyle(fontSize: 11, color: Colors.grey)),
                    ]),
                  ]),
                ),
                ...
                _sectionCard(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text('$_days يوم',
                          style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: primary)),
                      const Text('المدة', style: TextStyle(color: Colors.grey, fontFamily: 'NotoSansArabic')),
                    ]),
                    Slider(
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      const Text('30 يوم', style: TextStyle(fontSize: 11, color: Colors.grey)),
                      const Text('3 أيام', style: TextStyle(fontSize: 11, color: Colors.grey)),
                    ]),
                  ]),
                ),
                const SizedBox(height: 12),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: const Text('ابحث عن وجهات', style: TextStyle(
                        color: Colors.white, fontSize: 16, fontFamily: 'NotoSansArabic')),
                  ),
                ),
                if (_searched) ...[
    ...
    return GestureDetector(
      ...
      child: ClipRRect(
        ...
        child: Stack(fit: StackFit.expand, children: [
          ...
          Positioned(bottom: 8, right: 8, left: 8, child: Text(
            country['name'] ?? '', textAlign: TextAlign.right,
