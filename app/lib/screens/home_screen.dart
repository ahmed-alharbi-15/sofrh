...
class _FooterSection extends StatelessWidget {
  final void Function(int) jumpTo;
  const _FooterSection({required this.jumpTo});
    ...
    return Container(
      ...
      child: Directionality(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            children: [
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('سفرة',
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Text('وجهتك للسفر والطعام حول العالم',
                      style: TextStyle(
              ...
              Expanded(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const SizedBox(height: 10),
                  ...[ ('الرئيسية', 0), ('الدول', 1),
                       ('الفعاليات', 2), ('الوصفات', 3),
                       ('خطتي', 4) ].map((e) => GestureDetector(
                    onTap: () => jumpTo(e.$2),
                    child: Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('تواصل معنا',
                      style: TextStyle(
                          ...
                          fontFamily: 'NotoSansArabic')),
                  const SizedBox(height: 10),
                  _contactRow('📧', 'Sofrh.info@gmail.com'),
                  const SizedBox(height: 6),
                  _contactRow('📧', 'Sofrh.support@gmail.com'),
                  const SizedBox(height: 6),
                  _contactRow('🐦', 'X — @sofrah_sa'),
                ]),
              ),
            ],
          ),
          ...
          Column(children: [
            Text('© 2025 سفرة — جميع الحقوق محفوظة',
                textAlign: TextAlign.center,
                style: TextStyle(
  ...
  Widget _contactRow(String emoji, String text) => Row(children: [
