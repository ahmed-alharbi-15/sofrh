...
(function() {
    ...
    // .navbar / .side-menu / .site-footer / .hero(-open) / .country-name / .modal /
    // .profile-page / #loadingScreen غامقة أصلاً بتصميم الموقع - نستثنيها من الانعكاس
    // حتى ما تنقلب فاتحة. .profile-content بديل .profile-page عشان الشريط الجانبي
    // للبروفايل (position: fixed) ما ينكسر لو انعكس أبوه.
    ...
    style.textContent = `
        ...
        html[data-theme="dark"] body > *:not(.navbar):not(.side-menu):not(.site-footer):not(.hero):not(.hero-open):not(.country-name):not(.modal):not(.profile-page):not(#loadingScreen):not(#dark-mode-toggle):not(#safra-toast) {
